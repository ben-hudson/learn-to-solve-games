...
cache, splits it into cal / val / test, and calibrates the streaming sampling range from the
calibration equilibria (see ``MarkovTrafficEquilibrium.calibrate_range`` and ``train_field_gnn.py``).
